...
| 2026-07-27 | Sprint-change (free-tier-first Supabase — see `sprint-change-proposal-2026-07-27-supabase-tier.md`): AC-1 revised — preview branching deferred to whenever the project upgrades to Pro; prod now explicitly starts on the free tier. No code change; `supabase/PROVISIONING.md` and `epics.md` AR-12/Story 2.1 AC-1 wording updated to match. Status remains `done`. |
