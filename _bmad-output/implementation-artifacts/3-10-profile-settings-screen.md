...
- [ ] **Task 12 — Verification & gates** (AC: all)
  ...
  - [ ] **One design/motion polish pass at the end** (D-19, [[feedback_polish_at_end]]) — run the CLAUDE.md audit cycle (ui-ux-pro-max / apple-design / web-design-guidelines / writing-guidelines) after functional completion, not during.
